        ...
        <>
            ...
            <form >
                ...
                <div className="w-3/5  container mx-auto mt-[12rem]">
                    <h4 className="text-white font-bold text-[2rem] text-center mb-3">Degame tu inquietud o saludame..!</h4>
                    ...
                    <button className="btn w-full bg-[#0a192f] border-cyan-600 hover:bg-[#0a192f]  text-cyan-600 mb-[5rem]">Enviar</button>
                </div>
            </form>
